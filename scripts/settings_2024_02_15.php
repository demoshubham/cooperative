...
?>
		...
		-->
			<div class="sidebar-wrapper">
				...
				<ul class="nav">
					<li routerlinkactive="active" class="nav-item"><a class="nav-link" href="sammelen_reg_form.php"><i class="fa fa-exclamation-circle"></i><p>सहकारिता महासम्मेलन प्रपत्र</p></a></li>
					<?php
					// print_r($_SESSION);
