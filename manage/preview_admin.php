...
?>
	...
	<!-------------------1st start--------------------------------------------------------------------->
												<div class="step">
													...
													<div class="col-sm-12">
														...
														<div class="row">
															...
															<div class="col-sm-2 form-group">
																...
																<input  type="text" name="society_registration_date" id="society_registration_date" tabindex="<?php echo $tab++; ?>"  class="form-control" value="<?php echo date("d-m-Y", strtotime($row_invoice['society_registration_date'])); ?>">
															</div>
															<div class="col-sm-4 form-group">
													...
													<button class="btn btn-warning" type="button" onClick="save_draft(0)"><i class="fas fa-save"></i> Save Draft</button>
												</div>
	<!----------------2.1 start-------------------------------------------------------->
												<div class="step">
													...
													<button class="btn btn-warning" type="button" onClick="save_draft(1)"><i class="fas fa-save"></i> Save Draft</button>
												</div>
	<!------------------2.2 Start---------------------------------------------------------------------->
												<div class="step">
													...
													<button class="btn btn-warning" type="button" onClick="save_draft(2)"><i class="fas fa-save"></i> Save Draft</button>
												</div>
	<!---------------3rd Start---------------------------------------------------------------->
												...
												<div class="step">
													...
													<button class="btn btn-warning" type="button" onClick="save_draft(3)"><i class="fas fa-save"></i> Save Draft</button>
												</div>
	<!--------------4th Start---------------------------------------------------------------->
												<div class="step">
													...
													<button class="btn btn-warning" type="button" onClick="save_draft(4)"><i class="fas fa-save"></i> Save Draft</button>
												</div>
<!-------------5th start-------------------------------------------------------->												
												<div class="step">
													...
													<button class="btn btn-warning" type="button" onClick="save_draft(5)"><i class="fas fa-save"></i> Save Draft</button>
												</div>
	<!---------------6th Start---------------------------------------------------------------->
												<div class="step">
													...
													<button class="btn btn-warning" type="button" onClick="save_draft(6)"><i class="fas fa-save"></i> Save Draft</button>
												</div>
	<!----------9th start-------------------------------------------------------->
												<div class="step">
													...
													<div class="col-sm-12">
														...
														<button class="btn btn-warning" type="button" onClick="save_draft(7)"><i class="fas fa-save"></i> Save Draft</button>
													</div>	
											</div>
...
function save_draft(current_step){
