...
?>
				...
				<div class="row">
                        <div class="col-md-12">
                           	<!--<h3 style="color: #f00;">समितियां जिसमें मुख्य भूमि 2 एकड़ (0.8093713 हेक्टेयर) से ज्यादा है । </h3>-->
									...
									<thead>
										<tr>
										 ...
										 <?php
											...
											execute_query($sql);
											$sql = 'SELECT test2.sno as sno, survey_invoice_sec_3_1.survey_id, col1, division_name, col2, district_name, col3, col4, col5, col6, col7, mobile_number, respondent_name, abs(total_area) as total_area,
											last_year_profit_loss, last_year_pl_amount, seq_year_profit_loss, seq_year_pl_amount
											FROM `survey_invoice_sec_2_1` 
											left join survey_invoice_sec_3_1 on survey_invoice_sec_2_1.survey_id = survey_invoice_sec_3_1.survey_id 
											left join survey_invoice on survey_invoice.sno = survey_invoice_sec_3_1.survey_id 
