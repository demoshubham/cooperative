                                    ...
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
											...
											<tr>
												...
												?></td>
												<td><?php echo round($estimate['floor_total'],2); ?></td>
												<td><?php echo round($estimate['paint_total'],2); ?></td>
												<td><?php echo round($estimate['roof_total'],2); ?></td>
												<td><?php echo round($estimate['plaster_wall_total'],2); ?></td>
												<td><?php echo round($estimate['plaster_roof_total'],2); ?></td>
