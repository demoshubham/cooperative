...
if(isset($_POST['submit'])) {
	...
	if($msg==''){
		...
		if($inv!=0){
			$sql = 'insert into ar_dr_details (ar_id, district_id) values ("'.$inv.'","'.$_POST['division_name'].'")';
			//echo $sql;
			execute_query($sql);
			if(mysqli_error($db)){
				$msg .= '<li>Error # 2 : '.mysqli_error($db).' >> '.$sql.'</li>';
													...
													<div class="col-sm-3 form-group">
														...
														<select name="division_name" id="division_name" tabindex="<?php echo $tab++; ?>"  class="form-control">
															...
															while($row_district = mysqli_fetch_assoc($result_district)){
																...
																echo '>'.$row_district['division_name'].'</option>';
															}
                            ...
                            <div class="card strpied-tabled-with-hover">
								...
								<table class="table table-hover table-striped text-center">
                                        ...
                                        <tbody>
                                           	<?php
											$i=1;
											$sql = 'select ar_dr.sno as sno, ar_dr.ar_name as ar_name, ar_dr.mobile_number as mobile_number,  ar_dr.division_name as division_name, ar_dr.tehseel_name as tehseel_name, ar_dr_details.ar_id as ar_id, ar_dr_details.district_id as district_id from ar_dr left join ar_dr_details on ar_dr.sno = ar_dr_details.ar_id';
											//echo $sql;
											$result = execute_query($sql);
