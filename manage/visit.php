...
if(isset($_POST['district_name'])){
	...
	if(mysqli_num_rows($result_invoice)==1){
		...
		if(mysqli_num_rows($res_3_4)!=0){
			$row_3_4 = mysqli_fetch_assoc($res_3_4);
			$row_3_4['sec_3_b_godown_length'] = $row_3_4['length'];
			$row_3_4['sec_3_b_godown_width'] = $row_3_4['width'];
			$row_3_4['sec_3_b_storage_capacity'] = $row_3_4['storage_capacity'];
			$row_3_4['sec_3_b_comment'] = $row_3_4['remarks'];
		}
		else{
			$row_3_4['sec_3_b_godown_length'] = '';
			$row_3_4['sec_3_b_godown_width'] = '';
			$row_3_4['sec_3_b_storage_capacity'] = '';
			$row_3_4['sec_3_b_comment'] = '';
		...
		if(mysqli_num_rows($res_4)!=0){
			...
			$row_4['sec_4_casting_hiring'] = $row_4['custom_hiring_center'];
...
<script src="js/survey_validation.js?v=1"></script>
<?php
page_header_end();
page_sidebar();
															...
															<div class="col-md-8">
																<div class="row">
																	<div class="col-md-2">
																		...
																		<input type="text" id="lat" disabled="disabled" value="" class="form-control">
																		<label>Longitude</label>
																		<input type="text" id="long" disabled="disabled" value="" class="form-control">
												...
												<div class="step">
													...
													<div class="col-sm-12">
														<div class="row">
															<div class="col-sm-4 form-group">
																<label>सचिव</label>
																<select class="form-control " type="select"  value="yes" name="sec_2_secretary" id="sec_2_secretary" tabindex="<?php echo $tab++;?>" onChange="hide_show(this.value, '#sachiv_cader', 'yes')">
																	<option value="">--Select--</option>
																	<option value="yes" <?php $cader_display='none'; if($row_2_2['secretary']=='yes'){ echo ' selected="selected" '; $cader_display='block';}?>>है</option>
																	<option value="no" <?php if($row_2_2['secretary']=='no'){ echo ' selected="selected" '; $cader_display='none';}?>>नहीं</option>
																</select>
															</div>
														...
														<div class="col-sm-12">
															...
															<div class="row">
																<div class="col-sm-3 form-group">
																	...
																	<input type="number" name="sec_3_a_land_length" id="sec_3_a_land_length" tabindex="<?php echo $tab++; ?>" class="form-control" onBlur="show_sides_of_land(this.value);" max="6" value="<?php echo $row_3_1['number_of_sides'];?>">
																</div>
																<div class="col-sm-3 form-group">
															...
															<div class="row">
																...
																?>
																<div class="col-sm-2 form-group">
																	<img src="<?php echo $row_3_1['new_photo_id']; ?>" class="img-fluid img-thumbnail" style="height:50px;">
															...
															<div class="row">
																<div class="col-sm-3 form-group">
																	<label>लंबाई (मीटर में)</label>
																	<input type="text" name="sec_3_b_godown_length" id="sec_3_b_godown_length" tabindex="<?php echo $tab++; ?>" class="form-control" value="<?php echo $row_3_4['sec_3_b_godown_length'];?>">
																</div>	
																<div class="col-sm-3 form-group">
																	<label>चौड़ाई (मीटर में)</label>
																	<input type="text" name="sec_3_b_godown_width" id="sec_3_b_godown_width" tabindex="<?php echo $tab++; ?>" class="form-control" value="<?php echo $row_3_4['sec_3_b_godown_width'];?>">
																</div>
																<div class="col-sm-3 form-group">
																	<label>क्षमता (मेट्रिक टन में)</label>
																	<input type="text" name="sec_3_b_storage_capacity" id="storage_capacity" tabindex="<?php echo $tab++; ?>" class="form-control" value="<?php echo $row_3_4['sec_3_b_storage_capacity'];?>">
																</div>	
																<div class="col-sm-3 form-group">
																	<label>टिप्पणी</label>
																	<input type="text" name="sec_3_b_comment" id="sec_3_b_comment" tabindex="<?php echo $tab++; ?>"  class="form-control" value="<?php echo $row_3_4['sec_3_b_comment'];?>">
																</div>		
															</div>
															...
															<div class="row">
																...
																<div class="col-sm-3 form-group">
																	...
																	<select name="sec_4_casting_hiring" id="sec_4_casting_hiring" tabindex="<?php echo $tab++; ?>" class="form-control">
																		<option value="">--Select--</option>
																		<option value="yes" <?php echo $row_4['sec_4_casting_hiring']=='yes'?' selected="selected"':'';?>>है</option>
																		<option value="no" <?php echo $row_4['sec_4_casting_hiring']=='no'?' selected="selected"':'';?>>नहीं</option>
																	</select>
																</div>
																<div class="col-sm-3 form-group">
																	<label>ड्रोन</label>
																...
																<div class="col-sm-12">
																	...
																	<div class="row">
																		...
																		<div class="col-sm-4 form-group">
																			...
																			<input type="file" name="sec_6_a_img" id="sec_6_a_img" tabindex="<?php echo $tab++; ?>" class="form-control">
																		</div>					
																		<?php
																		if (file_exists($row_5['sec_6_a_img'])) {
																		?>
																		<div class="col-sm-2 form-group">
																			<img src="<?php echo $row_5['sec_6_a_img']; ?>" class="img-fluid img-thumbnail" style="height:50px;">
																	...
																	<div class="row">
																		...
																		<div class="col-sm-2 form-group">
																			<label>फोटो संलग्न करें</label>
																			<input type="file" name="sec_6_b_img" id="sec_6_b_img" tabindex="<?php echo $tab++; ?>" class="form-control">
																		</div>
																		<?php
																	...
																	<div class="row">
																		...
																		<div class="col-sm-2 form-group">
																			<label>फोटो संलग्न करें</label>
																			<input type="file" name="sec_6_c_img" id="sec_6_c_img" tabindex="<?php echo $tab++; ?>" class="form-control">
																		</div>
																		<?php
																	...
																	<div class="row">
																		...
																		<div class="col-sm-2 form-group">
																			<label>फोटो संलग्न करें</label>
																			<input type="file" name="sec_6_d_img" id="sec_6_d_img" tabindex="<?php echo $tab++; ?>" class="form-control">
																		</div>		
																		<?php
																	...
																	<div class="row">
																		<div class="col-sm-2 form-group">
																			...
																			<select name="sec_6_e_floor" id="sec_6_e_floor" tabindex="<?php echo $tab++; ?>" class="form-control" onChange="hide_show(this.value, '#bathroom_floor', 'repairable')">
																				...
																				<option value="repairable" <?php if($row_5['sec_6_e_floor']!='good'){echo ' selected="selected"'; $bathroom_floor_display='block';}?>>मरम्म्त योग्य</option>
																			</select>
																		</div>	
																		...
																		<div class="col-sm-2 form-group">
																			...
																			<select name="sec_6_e_plaster" id="sec_6_e_plaster" tabindex="<?php echo $tab++; ?>" class="form-control" onChange="hide_show(this.value, '#bathroom_plaster', 'repairable')">
																				...
																				<option value="repairable" <?php if($row_5['sec_6_e_plaster']!='good'){echo ' selected="selected"'; $bathroom_plaster_display='block';}?>>मरम्म्त योग्य</option>
																			</select>
																		</div>	
																		...
																		<div class="col-sm-2 form-group">
																			...
																			<select name="sec_6_e_ceiling" id="sec_6_e_ceiling" tabindex="<?php echo $tab++; ?>" class="form-control" onChange="hide_show(this.value, '#bathroom_roof', 'repairable')">
																				...
																				<option value="repairable" <?php if($row_5['sec_6_e_ceiling']!='good'){echo ' selected="selected"'; $bathroom_ceiling_display='block';}?>>मरम्म्त योग्य</option>
																			</select>
																		</div>	
																	...
																	<div class="row">
																		<div class="col-sm-2 form-group">
																			...
																			<select name="sec_6_e_seat" id="sec_6_e_seat" tabindex="<?php echo $tab++; ?>" class="form-control" onChange="hide_show(this.value, '#bathroom_seat', 'repairable')">
																				...
																				<option value="repairable" <?php if($row_5['sec_6_e_seat']!='good'){echo ' selected="selected"'; $bathroom_seat_display='block';}?>>मरम्म्त योग्य</option>
																			</select>
																		</div>
																		...
																		<div class="col-sm-2 form-group">
																			...
																			<select name="sec_6_e_plumbing" id="sec_6_e_plumbing" tabindex="<?php echo $tab++; ?>" class="form-control" onChange="hide_show(this.value, '#bathroom_plumbing', 'repairable')">
																				...
																				<option value="repairable" <?php if($row_5['sec_6_e_plumbing']!='good'){echo ' selected="selected"'; $bathroom_plumbing_display='block';}?>>मरम्म्त योग्य</option>
																			</select>
																		</div>	
	...
	<!----------9th start-------------------------------------------------------->
												...
												<div id="success">
												   <div class="mt-5">
													  ...
													  <p>आपने प्रपत्र सफलता पूर्वक भर लिया है । अब प्रपत्र को उच्चाधिकारी के पास सत्यापन हेतु भेजा जाना है । कृप्या सत्यापन पर भेजने से पहले नीचे दर्शायें लिंक से फार्म खोल कर पुनः जाच कर लें । सब कुछ सही होने कि दशा में नीचे दिये बटन के माध्यम से सत्यापन के लिये आगे प्रेशित करें ।</p>
													  <a class="back-link" href="preview.php" target="_blank">प्रपत्र पुनः निरीक्षण के लिये देखे ➜</a>
												   </div>
												   <div class="col-md-12 text-center">
													   <button type="button" class="btn btn-info" onClick="$('#send_otp_button1').css('display', 'flex');">सत्यापन के लिये आगे प्रेशित करें</button>
													</div>
