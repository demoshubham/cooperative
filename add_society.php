...
if(isset($_GET['del'])){
	$sql = 'update test2 set status = "1" where sno='.$_GET['del'];
	execute_query($sql);
	if(mysqli_error($db)){
		$msg .= '<li>Error # 2 : '.$sql.'</li>';
	}
	else{
		$msg .= '<li>Status Updated.</li>';
	}
}
								...
								<table class="table table-hover table-striped text-center">
                                        ...
                                        <tbody>
											...
											<tr style="background-color:<?php echo $col ;?> ">
												...
												<td class="text-center"><a href="<?php echo $_SERVER['PHP_SELF'].'?del='.$row['sno'];?>" onclick="return confirm('Are you sure?');" style="color:#36454F" alt="Delete"><span class="far fa-trash-alt" aria-hidden="true" data-toggle="tooltip" title="Delete"></span></a></td>
                                            </tr>
