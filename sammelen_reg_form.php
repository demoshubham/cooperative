                                ...
                                <div class="col-md-12">
                                    ...
                                    <?php echo $i; ?>.
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>तहसील</label>
                                                <select class="form-control" name="member_tehseel<?php echo $i; ?>" id="member_tehseel<?php echo $i; ?>"  required onChange="member_fill_block_name(this.value, <?php echo $i; ?>);">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <select name="memberType1" id="memberType1"  class="form-control" >
													...
													<option value="उपाअध्यक्ष">उपाअध्यक्ष</option>
													<option value="प्रबंध समिति संचालक">प्रबंध समिति संचालक</option>
